                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            {/* We build digital solutions to help businesses scale */}
                                Welcome to Patil Pumps
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">We deliver total industrial pumping solutions backed by decades of expertise and innovation. For over 30 years, Patil Pumps has been trusted for pioneering advances in centrifugal process pumps, positive displacement pump designs, and dependable sealing solutions for diverse industrial needs.</div>
